...
<html lang="en">
          ...
          <div class="content-wrapper">
            <div class="row">
              ...
              <div class="col-lg-12 stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Emoployee registeration list</h4>
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        $sql = "SELECT * FROM `empregister` WHERE `status`='pending'";
  ...
  <?php
     ...
     {
        $sql = "UPDATE `empregister` SET `status`='approved' WHERE `empid`='$_POST[empid]'  ";
...
<?php
     ...
     {
        $sql = "UPDATE `empregister` SET `status`='reject' WHERE `empid`='$_POST[empid]'  ";
