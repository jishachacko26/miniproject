                      ...
                      <h4 class="card-title">farming</h4>
                       ...
                       "enctype="multipart/form-data"onsubmit ="return validateForm()">
                          ...
                          <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">shop number</label>
                            <div class="col-sm-9">
                            <input type="text" class="form-control" id="exampleInputPassword2" placeholder="shop number" name="shop_no"onclick="allnumeric(document.form1.text1)" required="">
                            </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="text" class="form-control" id="exampleInputPassword2" placeholder="Adhaar number" name="adhno"  pattern="^[2-9]{1}[0-9]{3}\\s[0-9]{4}\\s[0-9]{4}$"required="">
                            </div></div>
                            <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="file" class="form-control" id="exampleInputPassword2" placeholder="lease document" name="lease" required="">
...
<?php
  ...
  $sql="INSERT INTO commecrial(shop_no,place,panchayathu,ward,Address,adhno,adhaar,own,signature,status,l_id)VALUES ('$_POST[shop_no]','$_POST[place]','$_POST[panchayathu]','$_POST[ward]','$_POST[Address]','$_POST[adhno]','$adhaar','$own','$sig','pending',$usr)";
...
<!--<?php
  ...
  require("userconnection.php");
  if(isset($_POST['submit'])){
  $sql="INSERT INTO commecrial(shop_no,place,panchayathu,ward,Address,adhno,adhaar,own,signature,status,l_id)VALUES ('$_POST[shop_no]','$_POST[place]','$_POST[panchayathu]','$_POST[ward]','$_POST[Address]','$_POST[adhno]','$_POST[adhaar]','$_POST[own]','$_POST[signature]','pending',$usr)";
                    ...
                    <div class="card">
                      ...
                      <h4 class="card-title">farming</h4>
                       ...
                       "enctype="multipart/form-data"onsubmit ="return validateForm()">
                            ...
                            <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">shop_no</label>
                            <div class="col-sm-9">
                            <input type="text" class="form-control" id="exampleInputPassword2" placeholder="shop_no" name="shop_no">
                            </div>
                          </div>
                         s
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">panchayathu</label>
                            <div class="col-sm-9">
                            <input type="text" class="form-control" id="exampleInputPassword2" placeholder="name" name="panchayathu">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">ward</label>
                          ...
                          <div class="form-group row">
                            ...
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Adhar file </label>
                            <div class="col-sm-9">
                            <input type="file" class="form-control" id="exampleInputPassword2" placeholder="Adhaar" name="Adhaar">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">ownership document </label>
                            <div class="col-sm-9">
                            <input type="file" class="form-control" id="exampleInputPassword2" placeholder="ownership document" name="own">
                            </div>
                          </div>
                           <div class="form-group row">
                            <label for="exampleInputPassword2" class="col-sm-3 col-form-label">signature </label>
                            <div class="col-sm-9">
                            <input type="file" class="form-control" id="exampleInputPassword2" placeholder="signature" name="signature">
