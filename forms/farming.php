...
var x = document.forms["myform"]["adhno"].value;
                      ...
                      <h4 class="card-title">farming</h4>
                       ...
                       "enctype="multipart/form-data"onsubmit ="return validateForm()">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="text" class="form-control" id="exampleInputPassword2" placeholder="farm number" name="f_no" required="">
                            </div>
                          </div>
                          <div class="form-group row">
 ...
 <!-- <?php
  ...
  $sql="INSERT INTO farm(f_name,f_no,place,panchayathu,ward,Address,adhno,adhaar,own,signature,status,l_id)VALUES 
  ('$_POST[f_name]','$_POST[f_no]','$_POST[place]','$_POST[panchayathu]','$_POST[ward]','$_POST[Address]','$_POST[adhno]','$_POST[adhaar]','$_POST[own]','$_POST[signature]','pending',$usr)";
